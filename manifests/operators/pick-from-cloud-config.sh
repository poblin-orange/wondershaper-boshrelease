...
# The base manifests/wondershaper.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/wondershaper.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
